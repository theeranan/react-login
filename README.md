...
**ต้องสร้างก่อนทุกอย่าง** - เพราะข้อมูลอื่นๆ ต้องอ้างอิงห้อง
...
**สร้างหลังห้องพัก** - เพราะต้องเลือกห้องที่จะเช่า
...
**สร้างหลังลูกค้า** - เพราะต้องเลือกลูกค้า/ห้อง
...
1. สมัครสมาชิก (Register) ✅
         ↓
2. สร้างห้องพัก (Rooms) 🏠 ← ต้องทำก่อนทุกอย่าง
         ↓
3. เพิ่มพนักงาน (Employees) 👷 ← ไม่บังคับ
         ↓
4. เพิ่มลูกค้า (Customers) 👥 ← ต้องมีห้องพักก่อน
         ↓
5. สร้างใบแจ้งหนี้ (Payments) 💰 ← ต้องมีลูกค้าก่อน
         ↓
6. แจ้งซ่อม (Repairs) 🔧 ← ต้องมีลูกค้าก่อน
```
...
#### 🛡️ Protected Routes (เส้นทางที่ต้องเข้าสู่ระบบก่อน)
